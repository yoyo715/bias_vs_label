...
def create_readme(DIM, WORDGRAMS, MINCOUNT, MINN, MAXN, BUCKET, EPOCH, LR, KMMLR, NUM_RUNS, SUBSET_VAL, KERN, LIN_C, BATCHSIZE):
    with open('/project/lsrtwitter/mcooley3/bias_vs_labelefficiency/output3/README.md ', '+a') as f:
...
def metrics(X, Y, A, B, N, test, trialnum, epoch):
    ...
    ftdir = '/project/lsrtwitter/mcooley3/bias_vs_labelefficiency/label_output3'
    fkmmtdir = '/project/lsrtwitter/mcooley3/bias_vs_labelefficiency/KMMlabel_output3'
...
def write_fastKMMtext_stats(runnum, train_loss, train_class_error, train_precision, train_recall, train_F1,
    ...
    d = '/project/lsrtwitter/mcooley3/bias_vs_labelefficiency/KMMoutput3'
...
def main():
    ...
    fname1 = '/project/lsrtwitter/mcooley3/bias_vs_labelefficiency/beta3/beta_original_'+str(run)+'.txt'
    ...
    fname2 = '/project/lsrtwitter/mcooley3/bias_vs_labelefficiency/beta3/beta_new1_'+str(run)+'.txt'
