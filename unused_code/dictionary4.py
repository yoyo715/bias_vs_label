...
from optimal_beta4 import kernel_mean_matching, kernel_mean_matching_NEW
...
class Dictionary:
    def __init__(self, ngrams, mincount, bucket, kern, subset_value, lin_c, run, model):
        ...
        #print("- creating manual instances FULL set")
        #self.create_instances_and_labels_manset_FULL()
    ...
    # this function creates the instances of the manually labeled (Kaggle) dataset
    def create_instances_and_labels_manset_FULL(self):
        words =  []
        labels = []
        documents = []
        whitelist = set('abcdefghijklmnopqrstuvwxyz ABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789 \t \n')
        ...
        for x in self.manual_set_full:
            if num != 361 and num != 360 and num != 359:
                ...
                documents.append(inst)
            num += 1
        self.manual_instances_full = documents
        self.y_manual_full = labels
        
        self.n_manual_instances_full = len(self.manual_instances_full)
    ...
    # bagngrams for the manually labeled dataset
    def create_manual_bagngrams_full(self):
        data_features = self.vectorizer.transform(self.manual_instances_full)    
        self.manual_test_bag_ngrams_full = data_features
    ...
    # index 0: label 0
    # index 1: label 1
    def create_manual_labels_full(self):
    ...
    def get_manual_testset_full(self):
        return self.manual_test_bag_ngrams_full
    ...
    def get_n_manual_instances_full(self):
        return self.n_manual_instances_full
    ...
    def get_manual_set_labels_full(self):
        return self.manual_label_vec_full
    ...
    def create_optbeta(self):
        ...
        opt_beta = kernel_mean_matching_NEW(self.manual_test_bag_ngrams, self.train_bag_ngrams,
		self.label_vec, self.lin_c, kern=self.kernel, B0=1.0, B1=5.0, eps=None)        
