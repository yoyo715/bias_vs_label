...
## sbatch new_bash.sh 1-outfilen 2-errfilen 3-learning_rate 4-Bval 5-trial


#Assign Job Name
#SBATCH --job-name=kmm_new
...
srun  python /project/lsrtwitter/mcooley3/bias_vs_labelefficiency/MAIN_ALL.py --run ${5} --learning_rate ${3} --b_val ${4} > newkmm_outfiles/${1}
