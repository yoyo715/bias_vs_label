...
class wFastText_cf:
    def __init__(self, dictionary, learning_rate):
        ...
        #self.betas = dictionary.get_optbeta()    
    ...
    def create_optbeta(self):
        ...
        opt_beta = kernel_mean_matching(self.manual_test_bag_ngrams, self.train_bag_ngrams,
                                            self.label_vec, self.lin_c, kern=self.kernel,
                                            B0=1.0, B1=5.0, eps=None)      
    ...
    def kernel_mean_matching(X, Z, y_labels, lin_c, kern='lin', B0=1.0, B1=1.0, eps=None):
        nx = X.shape[0]
        nz = Z.shape[0]
